...
list = List.create!(
  [
    {name: "豚肉",         name_kana: "ﾌﾞﾀﾆｸ",    price: "1000",  supplier: "にくやさん", lot: "1.0"},
    {name: "人参",         name_kana: "ﾆﾝｼﾞﾝ",    price: "130",   supplier: "八百屋",     lot: "0.15"},
    {name: "じゃがいも",   name_kana: "ｼﾞｬｶﾞｲﾓ",  price: "90",    supplier: "八百屋",     lot: "0.12"},
    {name: "卵",           name_kana: "ﾀﾏｺﾞ",     price: "280",   supplier: "とりや",     lot: "1"},
    {name: "玉ねぎ",       name_kana: "ﾀﾏﾈｷﾞ",    price: "110",   supplier: "八百屋",     lot: "0.12"},
    {name: "お米",         name_kana: "ｵｺﾒ",      price: "3000",  supplier: "八百屋",     lot: "5.0"},
    {name: "スパゲッティ", name_kana: "ｽﾊﾟｹﾞｯﾃｨﾞ", price: "1500",  supplier: "乾物",       lot: "5.0"},
    {name: "にんにく",     name_kana: "ﾆﾝﾆｸ",     price: "1000",  supplier: "八百屋",     lot: "1.0"},
    {name: "牛乳",         name_kana: "ｷﾞｭｳﾆｭｳﾞ",  price: "210",   supplier: "うしや",     lot: "1"},
    {name: "白ねぎ",       name_kana: "ｼﾛﾈｷﾞ",    price: "110",   supplier: "八百屋",     lot: "0.12"},

    {name: "豆腐",         name_kana: "ﾄｳﾌﾞ",     price: "88",    supplier: "大豆やさん", lot: "1"},
    {name: "ひき肉",       name_kana: "ﾋｷﾆｸ",     price: "770",   supplier: "にくやさん", lot: "1.0"},
    {name: "豆板醤",       name_kana: "ﾄｳﾊﾞﾝｼﾞｬﾝ", price: "520",   supplier: "ちょうみ",   lot: "0.5"},
    {name: "片栗粉",       name_kana: "ｶﾀｸﾘｺ",    price: "100",   supplier: "ちょうみ",   lot: "0.1"},
    {name: "粉チーズ",     name_kana: "ｺﾅﾁｰｽﾞ",   price: "280",   supplier: "ちょうみ",   lot: "0.12"},
    {name: "車海老",       name_kana: "ｸﾙﾏｴﾋﾞ",   price: "250",   supplier: "海鮮",       lot: "1"},
    {name: "酢",           name_kana: "ｽ",       price: "180",   supplier: "ちょうみ",   lot: "0.75"},
    {name: "砂糖",         name_kana: "ｻﾄｳ",     price: "180",   supplier: "ちょうみ",   lot: "1"},
    {name: "山葵",         name_kana: "ﾜｻﾋﾞ",    price: "200",   supplier: "八百屋",     lot: "50"},
    {name: "アスパラ",     name_kana: "ｱｽﾊﾟﾗ",   price: "130",   supplier: "八百屋",     lot: "1"},

    {name: "アサリ",       name_kana: "ｱｻﾘ",     price: "800",   supplier: "海鮮",       lot: "1"},
    {name: "蓼の葉",       name_kana: "ﾀﾃﾉﾊ",     price: "700",   supplier: "八百屋",    lot: "0.1"},
    {name: "鮎",           name_kana: "ｱﾕ",      price: "300",   supplier: "海鮮",       lot: "1"},
    {name: "塩",           name_kana: "ｼｵ",      price: "700",   supplier: "ちょうみ",   lot: "1"},
    {name: "鶏レバー",     name_kana: "ﾄﾘﾚﾊﾞｰ",   price: "2000",   supplier: "にくやさん",lot: "1"},
    {name: "ローリエ",     name_kana: "ﾛｰﾘｴ",     price: "500",   supplier: "八百屋",     lot: "0.1"},
    {name: "網脂",         name_kana: "ｱﾐｱﾌﾞﾗ",   price: "700",   supplier: "にくやさん", lot: "1"},
    {name: "ブランデー",   name_kana: "ﾌﾞﾗﾝﾃﾞｰ",  price: "1500",   supplier: "酒屋",      lot: "0.75"},
    {name: "キャトルエピス",name_kana: "ｷｬﾄﾙｴﾋﾟｽ",price: "400",   supplier: "ちょうみ",    lot: "0.02"},
    {name: "エシャロット", name_kana: "ｴｼｧﾛｯﾄ",  price: "100",   supplier: "八百屋",       lot: "30"},

    {name: "胡椒",         name_kana: "ｺｼｮｳ",    price: "200",   supplier: "ちょうみ",    lot: "30"},
    {name: "タイム",       name_kana: "ﾀｲﾑ",     price: "500",   supplier: "八百屋",     lot: "0.1"},
    {name: "アオリイカ",   name_kana: "ｱｵﾘｲｶ",   price: "1000",   supplier: "海鮮",       lot: "0.1"},
    {name: "そら豆",       name_kana: "ｿﾗﾏﾒ",    price: "600",   supplier: "八百屋",     lot: "0.1"},
    {name: "鶏がらスープ", name_kana: "ﾄﾘｶﾞﾗｽｰﾌﾟ",price: "350",   supplier: "ちょうみ",   lot: "0.1"},
    {name: "オリーブオイル",name_kana: "ｵﾘｰﾌﾞｵｲﾙﾟ",price: "1280", supplier: "ちょうみ",   lot: "0.1"},
    {name: "カレールー",   name_kana: "ｶﾚｰﾙｰﾞ",   price: "250",   supplier: "ちょうみ",   lot: "0.5"}
  ]
)
